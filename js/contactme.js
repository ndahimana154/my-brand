  function validateContactForm(event) {
    ...
    if (!firstName || !lastName || !email || !message) {
      document.getElementById('formErrorMessage').innerText = 'Please fill in all fields';
      return;
    }
    ...
    .catch(error => {
      ...
      document.getElementById('formErrorMessage').innerText = 'Failed to send message. Please try again later.';
    });
  }
